...
%>
<%
//Get Session Values i.e set on Facebook_predictor class.
HttpSession session1=request.getSession();
HashMap<String,String> post=null; 
%>
<% 	
 		
		//Get Hashmap from session which is set in Facebook_predictor class.
		HashMap<String,Integer> timeline_friends = (HashMap<String,Integer>)session1.getAttribute("timeline_friends");	
 		...
 		//Its description is same as on Facebook_predictor class.
...
%>
		...
		<!-- Left Part of Website to give two choices -->
		<div class="w3-center">
			<div class="w3-row">
				<div class="w3-col m2 w3-light-grey w3-padding-64" >
					
					<!--Want to post on facebook wall  -->
					<div class="w3-container w3-light-grey w3-padding-32 w3-btn  w3-xxlarge" ><button onclick="document.getElementById('id02').style.display='block',document.getElementById('id03').style.display='none'">Post</button></div>
					
					<!--Want to predict likes on facebook post  -->
					<div class="w3-container w3-light-grey w3-padding-32 w3-btn  w3-xxlarge" ><button onclick="document.getElementById('id03').style.display='block',document.getElementById('id02').style.display='none'">Predicter</button></div>      
    			
    			</div>
    				
    			<!--Three category of content can be post on facebook wall  -->
    			<div id="id02" class="w3-col m8 ">
					...
					<div class="w3-dropdown-hover w3-padding-64" >
						 ...
						 <div class="w3-dropdown-content w3-border ">
						 	<a  href="news_post?param1=sports" class="w3-btn" >Sports</a>
							<a href="news_post?param1=politics" class="w3-btn" >Politics</a>
						    <a href="news_post?param1=entertainment" class="w3-btn" >Entertainment</a>
				  		</div>
					</div>
				</div>

				<!--For Predict likes on Post you need to give Accesscode  -->
				<div id="id03" class="w3-col m8 " style="display:none;">
					<h1>Predict your post's like</h1>
					<div class="w3-padding-64">	
				    	<h2 class="w3-text-blue">Access Code</h2><br>
		...
		<!--Show Content of selected Category, that user want to post on thier FB wall -->
			...
			<div class="w3-modal-content w3-animate-top" style="overflow:scroll; height:30em;">
				<div class="w3-container w3-center w3-btn-group" >
			    	<span onclick="document.getElementById('id01').style.display='none'" class="w3-closebtn">&times;</span>
			  		 <h1>Which Post do you want to Post</h1>
			      	 <table class="w3-table w3-striped w3-bordered w3-card-4">
						...
						<tr>
							<td><%=hash%><br><%=value %></td>
						  	<td><a href="<c:url value="Facebook_predictor1"><c:param name="posting" value="<%=hv%>"/></c:url>" class="w3-btn" ><button class="w3-btn">Submit</button></a></td>
		...
		<!--Show predicted likes of a post  -->
			      	...
			      	<table class="w3-table w3-striped w3-bordered w3-card-4">
						...
						<tr>
							<td>
						  	...
						  	<td >
						  		<p>Name:<c:out value="${loginUser.id}" /></p>
			      	...
			      	<table class="w3-table w3-striped w3-bordered w3-card-4">
						...
						<c:forEach begin="0" end="5" var="loop">
							<tr>
							  ...
							  <td>
							  	<p>Name:<c:out value="${posts.get(loop).getName()}"/></p>
							  	<% 		
									i++;
									if(i==5)
										break;
		...
		<!--Show friends who is going to like post  -->
			...
			<div  class="w3-modal-content w3-animate-top" style="overflow:scroll; height:30em;">
				<div class="w3-container w3-center w3-btn-group" >
			    	<span onclick="document.getElementById('id05').style.display='none'" class="w3-closebtn">&times;</span>
			  		<h1>Friends who like your Post</h1>
		...
		<!--To post on FB wall, we need access code from a user.  -->
